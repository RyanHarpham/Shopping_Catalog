...
<html>
    <body>
        ...
        <div id="container">
            ...
            <p class="center">Add a product!</p>
            <form action="." method="post">
                <input type="hidden" name="action"
                       value="addProduct">
                <input type="submit" value="Click here to add a Product!" class="centerButton">
            </form><br><br>
            ...
            <div class="pagination">
                ...
                for ($page = 1; $page <= $number_of_pages; $page++) {
                    echo '<a href="index.php?action=manage_products&product_page=' . $page . '">' . $page . '</a> ';
                }
                ?>
            </div>
        </div>
